        ...
        <li>
            ...
            <div class="col-sm-11  col-md-10 main">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php if(is_array($posts["data"])): $i = 0; $__LIST__ = $posts["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($vo["pid"]); ?></td>
                            <td><?php echo ($vo["username"]); ?></td>
                            <td><?php echo msubstr(strip_tags($vo['content']),0, 50);?></td>
                            
                            <td><?php echo friendly_date($vo['create_time']);?></td>
                            <td>
                                <a href="<?php echo U('topic/delPost',array('pid'=>$vo['pid']));?>"><i class="fa fa-trash-o"></i></a>
                            </td>
